...
"<html>\
  ...
  <body>\
    ...
    <h1> Buttons</h1>\
      <button>\
         <a href=\"/runMachine\"> Run machine </a>\     
      </button>\
  </body>\
</html>";
...
void setup()
{
  ...
  //   String textvar = ("");
  //   String textvar += "CountDownTime: " + CountDownTimePara + "\nExperimentTime: " + ExperimentTimePara + "\nEndingSequense: " + EndingSequensePara + "AnExternFan: " + AnExternFanVoltPara + "AnSeperator: " + AnSeperatorVoltPara;
	// 	request->send(200, "text/plain", textvar);
	// });

  server.on("/runMachine", HTTP_GET, [](AsyncWebServerRequest * request) {
    Serial.println("Machine is Starting");    
    request->send(200, "text/html", "The Machine has begun");
  });
